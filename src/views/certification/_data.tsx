import azureImg from "../../assets/images/azr.png";
import dhis2Img from "../../assets/images/dhis2.jpg";
import dhisAgg from "../../assets/images/dhisAgg.png";

export const certificationData = [{
    id: 3,
    img: azureImg,
    company: "AZURE FUNDAMENTALS",
  ...
  },
  {
    id: 3,
    img: dhisAgg,
    company: "AGGREGATE CUSTOMIZATION FUNDAMENTALS, DHIS2",
    duration: "September 2020 - April 2021",
    body: "Frontend Developer",
    content:
      "ttes Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type",
...
export const flippedCertificationData = [
  {
    company: "INTRODUCTION TO DHIS2",
    duration: "October 2021 - Present",
    body: "Software Engineer",
